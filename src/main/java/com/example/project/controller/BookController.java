...
public class BookController {
    ...
    @GetMapping
    @Operation(summary = "Get all books", description = "Get a paginated"
    ...
    @PreAuthorize("hasRole('USER')")
    @GetMapping("/search")
    @Operation(summary = "Search books", description = "Search for "
            + "books dynamically using specifications with pagination")
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @PutMapping("/{id}")
    @Operation(summary = "Update a book", description = "Update "
            + "the details of an existing book by its ID")
